/**
 * Records Screen (My Wellness Record)
 * 
...
export default function RecordsScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea} edges={['top']}>
      ...
      >
        <Text style={styles.screenTitle}>My Wellness Record</Text>
        <Text style={styles.screenSubtitle}>Verified health profile & telemetry logs</Text>
